...
namespace TeacherPortal.Controllers
{
    ...
    public class PublicationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "No,Journal,Descr")] Publication publication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "No,Journal,Descr")] Publication publication)
        {
            if (ModelState.IsValid)
            {
